package com.dreamzone.mtime.robust;
...
/**
 * @author bohe
 * @ClassName: PatchManipulateImp
 * @Description:
 * @date 2018/2/4 上午1:06
 */
public class PatchManipulateImp extends PatchManipulate{
    ...
    protected List<Patch> fetchPatchList(Context context) {
        ...
        //请注意这里的设置
        patch.setPatchesInfoImplClassFullName("com.dreamzone.mtime.patch.PatchesInfoImpl");
